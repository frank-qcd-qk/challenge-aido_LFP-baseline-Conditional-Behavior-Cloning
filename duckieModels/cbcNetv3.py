...
class cbcNet:
    ...
    def build_cbc_net(rgb_image):
        ...
        prediction = Dense(500, kernel_initializer='normal', activation='relu', name='ANB_FC1')(prediction)
        ...
        y = Dense(50, kernel_initializer='normal', activation='relu', name='BCB_FC2')(prediction)
